...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{('/assets/educature/img/skanel.png')}}">
    <!-- Author Meta -->
    ...
    <link rel="stylesheet" href="{{('/assets/educature/css/linearicons.css')}}">
    <link rel="stylesheet" href="{{('/assets/educature/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{('/assets/educature/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{('/assets/educature/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{('/assets/educature/css/nice-select.css')}}">
    <link rel="stylesheet" href="{{('/assets/educature/css/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{('/assets/educature/css/animate.min.css')}}">
    <link rel="stylesheet" href="{{('/assets/educature/css/main.css')}}">
</head>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 col-md-6 about-left">
                <img class="img-fluid" src="{{('/assets/educature/img/about.jpg')}}" alt="">
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title text-center">
                    <h1>Kegiatan</h1>
                    <p>
                        Jenis-jenis kegiatan IKA yang akan dilaksanakan
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center d-flex align-items-center">
            <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div class="thumb d-flex justify-content-center">
                    <img class="img-fluid" src="{{('/assets/educature/img/faculty/f1.jpg')}}" alt="">
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div class="thumb d-flex justify-content-center">
                    <img class="img-fluid" src="{{('/assets/educature/img/faculty/f2.jpg')}}" alt="">
                </div>
                <div class="meta-text text-center">
                    <h4>Rodney Cooper</h4>
                    <p class="designation">Sr. Faculty Data Science</p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div class="thumb d-flex justify-content-center">
                    <img class="img-fluid" src="{{('/assets/educature/img/faculty/f3.jpg')}}" alt="">
                </div>
                <div class="meta-text text-center">
                    <h4>Dora Walker</h4>
                    <p class="designation">Sr. Faculty Data Science</p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
                <div class="thumb d-flex justify-content-center">
                    <img class="img-fluid" src="{{('/assets/educature/img/faculty/f4.jpg')}}" alt="">
                </div>
                <div class="meta-text text-center">
                    <h4>Lena Keller</h4>
                    <p class="designation">Sr. Faculty Data Science</p>
    ...
    <div class="container">
        <div class="testi-slider owl-carousel" data-slider-id="1">
            <div class="item">
                <div class="testi-item">
                    <img src="{{('/assets/educature/img/quote.png')}}" alt="">
                    <h4>Fanny Spencer</h4>
                    <ul class="list">
        ...
        <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="{{('/assets/educature/img/testimonial/t1.jpg')}}" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="{{('/assets/educature/img/testimonial/t2.jpg')}}" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="{{('/assets/educature/img/testimonial/t3.jpg')}}" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
            <div class="owl-thumb-item">
                <div>
                    <img class="img-fluid" src="{{('/assets/educature/img/testimonial/t4.jpg')}}" alt="">
                </div>
                <div class="overlay overlay-grad"></div>
            </div>
        </div>
...
<script src="{{('/assets/educature/js/vendor/jquery-2.2.4.min.js')}}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q"
        crossorigin="anonymous"></script>
<script src="{{('/assets/educature/js/vendor/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
<script src="{{('/assets/educature/js/easing.min.js')}}"></script>
<script src="{{('/assets/educature/js/hoverIntent.js')}}"></script>
<script src="{{('/assets/educature/js/superfish.min.js')}}"></script>
<script src="{{('/assets/educature/js/jquery.ajaxchimp.min.js')}}"></script>
<script src="{{('/assets/educature/js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{('/assets/educature/js/owl.carousel.min.js')}}"></script>
<script src="{{('/assets/educature/js/owl-carousel-thumb.min.js')}}"></script>
<script src="{{('/assets/educature/js/jquery.sticky.js')}}"></script>
<script src="{{('/assets/educature/js/jquery.nice-select.min.js')}}"></script>
<script src="{{('/assets/educature/js/parallax.min.js')}}"></script>
<script src="{{('/assets/educature/js/waypoints.min.js')}}"></script>
<script src="{{('/assets/educature/js/wow.min.js')}}"></script>
<script src="{{('/assets/educature/js/jquery.counterup.min.js')}}"></script>
<script src="{{('/assets/educature/js/mail-script.js')}}"></script>
<script src="{{('/assets/educature/js/main.js')}}"></script>
</body>
